...
categories = {
	'Simple Melee weapon   ': [
		Item("Club", "1 sp.", "1d4 bludgeon", 2, "Light", "Slow"),
		Item("Dagger", "2 gp.", "1d4 pierce", 1, "Finesse, Light, Thrown (range 20/60)", "Nick"),
		Item("Greatclub", "2 sp.", "1d8 bludgeoning", 10, "Two-handed", "Push"),
		Item("Handaxe", "5 gp.", "1d6 slashing", 2, "Light, Thrown (range 20/60)", "Vex"),
		Item("Javelin", "5 sp.", "1d6 piercing", 2, "Thrown (range 30/120)", "Slow"),
		Item("Hammer, Light", "2 gp.", "1d bludgeoning", 2, "Light, Thrown (range 20/60)", "Nick"),
		Item("Mace", "5 gp.", "1d6 bludgeoning", 4, "none", "Sap"),
		Item("Quarterstaff", "2 sp.", "1d6 bludgeoning", 4, "Versatile (1d8)", "Topple"),
		Item("Sickle", "1 gp.", "1d4 slashing", 2, "Light", "Nick"),
		Item("Spear", "1 gp.", "1d6 piercing", 3, "Thrown (range 20/60), Versatile (1d8)", "Sap")
		# ... other items in SimpleMelee category
	],
	'Simple Ranged weapon  ': [
        Item("Crossbow, Light", "25 gp.", "1d8 piercing", 5, "Ammunition (range 80/320), Loading, Two-handed", "Slow"),
		Item("Dart", "5 cp.", "1d4 piercing", 0.25, "Finesse, Thrown (range 20/60)", "Vex"),
		Item("Shortbow", "25 gp.", "1d6 piercing", 2, "Ammunition (range 80/320), Two-handed", "Vex"),
		Item("Sling", "1 sp.", "1d4 bludgeoning", 0, "Ammunition (range 30/120)", "Slow")
	...
	'Martial Melee weapon  ': [
		...
		Item("Morningstar", "15 gp", "1d8 piercing", 4, "none"),
		...
		Item("War pick", "5 gp", "1d8 piercing", 2, "none"),
		Item("War hammer", "15 gp", "1d8 bludgeoning", 2, "none")
